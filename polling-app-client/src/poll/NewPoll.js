...
class NewPoll extends Component {
  ...
  handleSubmit(pollData) {
    // pollData will be the form values collected by AntD Form.
    // But since you manage your own state, you can build pollData manually
    // or just use the state directly here.

    // Example using your component state:
    const data = {
        question: this.state.question.text,
        choices: this.state.choices.map(choice => ({ text: choice.text })),
    ...
    handlePollDaysChange(value) {
        const pollLength = {...this.state.pollLength, days: value};
        this.setState({
    ...
    handlePollHoursChange(value) {
        const pollLength = {...this.state.pollLength, hours: value};
        this.setState({
            pollLength: pollLength
        });
    }
    ...
    isFormInvalid() {
        ...
        return false;  // important to return false if no invalid
    }
